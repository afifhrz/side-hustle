...
ehr_inp["Investment_stages"] = [5]
ehr_inp["Energy_system_location"] = ["Ohio", "Oakley"]
...
exit(print(Demands.stack().stack().reorder_levels([3, 2, 0, 1]).to_dict()))
